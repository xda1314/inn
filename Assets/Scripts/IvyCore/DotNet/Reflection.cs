...
namespace IvyCore{
    ...
    public static class ReflectionExtension
    {
        ...
        //{
        //    var selfType = ReflectionExtension.GetAssemblyCSharp().GetType("...");
        //    Debug.Log(selfType);
        //}
        ...
        public static Assembly GetAssemblyCSharp()
        {
            ...
            Debug.Log(">>>>>>>Error: Can\'t find Assembly-CSharp.dll");
            return null;
        }

        public static Assembly GetAssemblyCSharpFirstPass()
        {
            var assemblies = AppDomain.CurrentDomain.GetAssemblies();
            foreach (var a in assemblies)
            {
                if (a.FullName.StartsWith("Assembly-CSharp-firstpass,"))
                {
                    return a;
                }
            }

            Debug.Log(">>>>>>>Error: Can\'t find Assembly-CSharp-firstpass.dll");
            return null;
        }

        public static Assembly GetAssemblyCSharpFirstPassEditor()
        {
            var assemblies = AppDomain.CurrentDomain.GetAssemblies();
            foreach (var a in assemblies)
            {
                if (a.FullName.StartsWith("Assembly-CSharp-Editor-firstpass,"))
                {
                    return a;
                }
            }

            Debug.Log(">>>>>>>Error: Can\'t find Assembly-CSharp-Editor-firstpass.dll");
            return null;
        }
        ...
        public static Assembly GetAssemblyCSharpEditor()
        {
            ...
            Debug.Log(">>>>>>>Error: Can\'t find Assembly-CSharp-Editor.dll");
            return null;
        }
